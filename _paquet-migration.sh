...
### - Fichier d'origine : ../plugins/auto/organiseur/plugin.xml
...
# svn add lang/paquet-organiseur_fr.php
...
# svn mv base/organiseur_upgrade.php organiseur_administrations.php
